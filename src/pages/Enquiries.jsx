      ...
      const dummyEnquiries = [
        {
          ...
          message: "I want to order 50 boxes of Kesar Laddu for a wedding. Do you provide a discount?",
          status: "new",
          isRead: false,
        ...
        },
        {
          ...
          message: "My order ORD1001 is not delivered yet. Please check.",
          status: "in-progress",
          isRead: true,
        ...
        },
        {
          ...
          message: "The sweets were amazing! Thank you.",
          status: "resolved",
          isRead: true,
