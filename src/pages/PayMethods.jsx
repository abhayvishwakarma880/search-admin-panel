...
function PayMethods() {
  ...
  const fetchMethods = async () => {
    try {
      ...
      const dummyMethods = [
        { _id: "PM001", name: "Cash on Delivery", status: true },
        { _id: "PM002", name: "UPI / QR Code", status: true },
        { _id: "PM003", name: "Credit/Debit Card", status: false },
        { _id: "PM004", name: "Net Banking", status: false }
      ];

      setMethods(dummyMethods);
    } catch (e) {
