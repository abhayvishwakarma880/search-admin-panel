      ...
      const dummyProducts = [
        {
          ...
          description: "Traditional Indian sweet made with saffron and pure ghee.",
          isActive: true,
          createdAt: new Date().toISOString(),
          about: { ingredients: "Besan, Ghee, Sugar, Saffron", shelfLife: "30 Days", netWeight: "500g" },
          mainImage: "kesar-laddu.jpg"
        },
        {
          _id: "P002",
          name: "Aloo Bhujia",
          ...
          finalPrice: 200,
          categoryId: "C002",
          category: { name: "Namkeen" },
          description: "Crispy and spicy potato noodles snack.",
          isActive: true,
          createdAt: new Date().toISOString(),
          about: { ingredients: "Potato, Gram Flour, Spices", shelfLife: "6 Months", netWeight: "200g" },
          mainImage: "aloo-bhujia.jpg"
        },
        {
          _id: "P003",
          ...
          categoryId: "C001",
          category: { name: "Sweets" },
          description: "Fine pearls of gram flour deep fried and soaked in syrup.",
          isActive: false,
          createdAt: new Date().toISOString(),
          about: { ingredients: "Besan, Sugar, Ghee", shelfLife: "15 Days", netWeight: "500g" },
          mainImage: "motichoor.jpg"
        }
      ];

      const filteredList = dummyProducts.filter(p => 
