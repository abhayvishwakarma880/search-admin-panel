  ...
  const fetchCategories = async () => {
    try {
      ...
      const dummyCategories = [
        { _id: "C001", name: "Sweets", slug: "sweets", description: "All kinds of delicious Indian sweets", isActive: true, createdAt: new Date().toISOString() },
        { _id: "C002", name: "Namkeen", slug: "namkeen", description: "Crispy and spicy Indian snacks", isActive: true, createdAt: new Date().toISOString() },
        { _id: "C003", name: "Gift Packs", slug: "gift-packs", description: "Assorted sweet boxes for occasions", isActive: true, createdAt: new Date().toISOString() },
        { _id: "C004", name: "Dry Fruits", slug: "dry-fruits", description: "Premium quality nuts and dried fruits", isActive: true, createdAt: new Date().toISOString() },
        { _id: "C005", name: "Inactive Cat", slug: "inactive-cat", description: "Testing inactive state", isActive: false, createdAt: new Date().toISOString() },
      ];

      // Filter by status like the real API would
      const filteredList = dummyCategories.filter(cat => 
