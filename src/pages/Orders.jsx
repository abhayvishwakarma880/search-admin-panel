      ...
      const dummyOrders = [
        {
          ...
          shippingAddress: { name: "Rahul Sharma", phone: "9876543210", addressLine1: "123, Street Name", city: "Mathura", state: "UP", pincode: "281001" },
          items: [{ productName: "Kesar Laddu", productPrice: 550, quantity: 2 }]
        },
        {
          _id: "ORD1002",
          userId: "U002",
          ...
          shippingAddress: { name: "Priya Singh", phone: "9988776655", addressLine1: "456, Apartment Block", city: "Agra", state: "UP", pincode: "282001" },
          items: [{ productName: "Motichoor Laddu", productPrice: 400, quantity: 2 }]
        }
      ];
